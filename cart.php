        ...
        <div class="dashboard">
            ...
            <div class="card">
                ...
                <a href="home.php">
                    ...
                    <button class="button-search" style="margin-top:20px;">
                        Mua sắm ngay
                    </button>
            ...
            <div class="card" style="margin-bottom:20px;">
                ...
                <?php if(!$isAddress){ ?><p style="color: red;">Vui lòng cập nhật số điện thoại và địa chỉ để tiếp tục mua hàng</p>
                <?php } ?>
            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div style="display:flex; align-items:center; gap:10px;">
                                    ...
                                    <button class="create_btn" disabled>
                                        +
                                    </button>
